...
public class EscolhePlayer
{
        ...
        public EscolhePlayer(Window janela)
        {
        ...
        private void carregarObjetos(Window janela)
        {
                ...
                backGround = new Sprite(URL.sprite("telaInicial.png"), 3);
        ...
        {                
                ...
                if (keyboard.keyDown(Keyboard.ENTER_KEY)){
                    ...
                    switch(opcaoEscolhida){
                        case 0:
                            new Cenario1(window, "Zack");
                        case 1:
                            new Cenario1(window, "Zumbi");
                        case 2:
                            new Cenario1(window, "Dragon");
                    }
                }
        }
